        ...
        <div className="flex flex-col gap-2 sm:gap-4 flex-1">
          <div className="flex items-center justify-between w-full">
            <h1 className="press-start text-base sm:text-3xl text-black flex items-center gap-2 truncate">
              <FaQuestionCircle className="text-yellow-500 text-lg sm:text-4xl" /> Question 2
            </h1>
            <Link href="/play4" className={!answered ? 'pointer-events-none opacity-50' : ''} tabIndex={!answered ? -1 : 0} aria-disabled={!answered}>
          ...
          <p className="press-start text-center text-black text-xs sm:text-base mb-2 sm:mb-8 max-w-xs sm:max-w-2xl mx-auto tracking-tight break-words" style={{ letterSpacing: '-0.07em' }}>
            Pixel Bonk introduced two iconic pixelated figures: Bonk the Gangster Frog, a cool, pipe-smoking enforcer of the blockchain, and Bonk the Wizard, a mysterious spellcaster guiding the future of the project through community governance.
          </p>
          <div className="press-start text-black text-xs sm:text-base max-w-xs sm:max-w-2xl mx-auto tracking-tight flex flex-col gap-2" style={{ letterSpacing: '-0.07em' }}>
            <div className="mb-2">Question 2:</div>
            <div className="mb-2">Who is responsible for leading the community with spells of governance?</div>
