...
const options = [
  "Cashback offers",
  "Special powers and upgrades in games",
        ...
        <div className="flex flex-col gap-2 sm:gap-4 flex-1">
          <div className="flex items-center justify-between w-full">
            <h1 className="press-start text-base sm:text-3xl text-black flex items-center gap-2 truncate">
              <FaQuestionCircle className="text-yellow-500 text-lg sm:text-4xl" /> Question 6
            </h1>
            <Link href="/play8" className={!answered ? 'pointer-events-none opacity-50' : ''} tabIndex={!answered ? -1 : 0} aria-disabled={!answered}>
          ...
          <p className="press-start text-center text-black text-xs sm:text-base mb-2 sm:mb-8 max-w-xs sm:max-w-2xl mx-auto tracking-tight break-words" style={{ letterSpacing: '-0.07em' }}>
            Each character in Pixel Bonk is available as a limited-edition NFT, allowing users to trade, showcase, or even use them in gameplay. These collectibles offer special powers and visual upgrades in upcoming game releases.
          </p>
          <div className="press-start text-black text-xs sm:text-base max-w-xs sm:max-w-2xl mx-auto tracking-tight flex flex-col gap-2" style={{ letterSpacing: '-0.07em' }}>
            <div className="mb-2">Question 6:</div>
            <div className="mb-2">What additional benefit do Pixel Bonk NFTs offer beyond being collectibles?</div>
