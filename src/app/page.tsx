...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,_#82e3fc,_#a0e66f)] flex justify-center items-center">
      <div className="w-full max-w-[95vw] sm:max-w-7xl mx-auto px-2 flex flex-col border-8 border-black rounded-2xl shadow-2xl bg-[url('/bgImg2.png')] bg-cover bg-center relative mt-4 mb-4" style={{ backgroundColor: 'rgba(255,255,255,0.95)' }}>
        <Navbar />
